...
#define FIND_DLG_WIDTH   380
#define FIND_DLG_HEIGHT   160
static DLGTEMPLATE DlgInitProgress =
{
    WS_CAPTION | WS_BORDER | WS_VISIBLE,
    WS_EX_TOPMOST,
    0, 0, FIND_DLG_WIDTH, FIND_DLG_HEIGHT,
    "Find in This Page",
    0, 0,
    9, NULL,
    0
...
static LRESULT InitDialogBoxProc (HWND hDlg, unsigned int message, WPARAM wParam, LPARAM lParam)
{
    switch (message) {
        case MSG_INITDIALOG:
            ...
            MoveWindow (hDlg , (rc.right-rc.left-FIND_DLG_WIDTH)/2 , (rc.bottom-rc.top-FIND_DLG_HEIGHT)/2 , FIND_DLG_WIDTH , FIND_DLG_HEIGHT , TRUE);
