...
{
    {
        CTRL_STATIC,
        WS_VISIBLE | SS_LEFT,
		10*PLUG_WIDTH/300, 20*PLUG_HEIGHT/300,
		280*PLUG_WIDTH/300, 60*PLUG_HEIGHT/300,
		0,
    ...
    },
    {
		...
		10*PLUG_WIDTH/300, 60*PLUG_HEIGHT/300,
		280*PLUG_WIDTH/300, 110*PLUG_HEIGHT/300,
        IDC_SET_PLUGIN_LIST,
        "",
        0
    },
    {
        CTRL_STATIC,
        WS_VISIBLE | SS_LEFT,
		10*PLUG_WIDTH/300, 180*PLUG_HEIGHT/300,
		280*PLUG_WIDTH/300, 50*PLUG_HEIGHT/300,
    ...
    },
    {
		...
		50*PLUG_WIDTH/300, 240*PLUG_HEIGHT/300,
		92*PLUG_WIDTH/300, 25*PLUG_HEIGHT/300,
        IDOK, 
        "Ok",
        0
    },
    {
        CTRL_BUTTON,
        WS_TABSTOP | WS_VISIBLE | BS_DEFPUSHBUTTON, 
		170*PLUG_WIDTH/300, 240*PLUG_HEIGHT/300,
		92*PLUG_WIDTH/300, 25*PLUG_HEIGHT/300,
        IDCANCEL, 
        "Cancel",
        0
